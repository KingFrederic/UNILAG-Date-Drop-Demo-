...
export const playbooks: Playbook[] = [
  /* ------------------------------ digital ------------------------------ */
  {
    ...
    maths: {
      ...
      target: 5_000_000,
      margin: 0.92,
      note: "228 sales a day for three years — roughly 1,250 copies per title across a 200-book catalogue. That is an ordinary number per book, which is the whole argument for breadth over one hero product.",
    },
    phases: [
      { year: "Year 1", focus: "Low-content categories shipped first — fastest to produce, 40 titles live", revenue: 200_000 },
      { year: "Year 2", focus: "Fiction series begun; read-through compounds across each series", revenue: 1_300_000 },
      { year: "Year 3", focus: "Full 200-title catalogue live; backlist carries sales", revenue: 3_500_000 },
    ],
    launchSteps: [
      "Start with the low-content categories — puzzle books, journals and logs ship in days, not months",
      "Publish three titles in one category before moving on; the algorithm rewards depth",
      "Enrol in Kindle Unlimited so page-reads pay while the catalogue is still small",
      "Use the tracker's status column honestly — only 'Published' counts toward the target",
      "Once a category sells, write the remaining seven titles in it before starting another",
      "Move to fiction series last; they take longest but read-through compounds hardest",
    ],
    platforms: [
      "Amazon KDP",
      "Kindle Unlimited",
